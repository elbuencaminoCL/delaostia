...
<section id="aboutUs">
  <div class="about-us-row">
    ...
    <div class="container center-xs about-us-row-content">
      ...
      <div class="about-us-carousel">
        ...
        <?php if ( have_rows( 'clone_about_us_carousel_content_repeater' ) ) : ?>
          <?php while ( have_rows( 'clone_about_us_carousel_content_repeater' ) ) : the_row(); ?>
            <div class="about-us-carousel-bg" style="background-image: url('<?php the_sub_field( 'about_us_carousel_image' ); ?>'); width: 800px; margin: 0 20px; background-size: cover;">
